...
def draw(scr: pygame.surface.Surface):
    scr.fill((0, 0, 0))
    pygame.draw.rect(scr, pygame.Color("orange"),
                     (10, 10, 500, 200))
    pygame.draw.circle(scr, (10, 0, 100), (300, 300), 200)
    pygame.draw.line(scr, (0, 0, 255), (0, 0),
                     (scr.get_width(), scr.get_height()), 10)
    pygame.draw.polygon(scr, (100, 0, 100), ((10, 10),
                                             (100, 500),
                                             (700, 200)))
